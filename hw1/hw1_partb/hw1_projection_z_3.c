...
int main(int argc, char **argv)
{
	...
	for (t = 0.01; t < 10000.01; t += .01)  //change the t range
	{
		...
		xprime = f_prime*x/z;			/* this is an example of orth */
		yprime = f_prime*y/z;			
		float x_hat_prime = f_prime*x_hat/z_hat;
		float y_hat_prime = f_prime*y_hat/z_hat;
	...
	ofile = "projection_z_3.ras";// this is the name of your output file, modify the name according to the requirements
